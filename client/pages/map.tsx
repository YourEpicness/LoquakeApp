...
const Map: NextPage = () => {
	...
	useEffect(() => {
		...
		loader.load().then(() => {
			...
			const initMarker:any = new google.maps.Marker({
				position: {
					lat: 41.842785,
					lng: -87.749486,
				},
			...
			function drawCircle(center:any) {
	...
	function getEarthquakes() {
		axios.get('http://localhost:3005/earthquakes').then((res) => {
			console.log(res)
		})
	}
	...
	return (
		<div className='flex flex-col items-center bg-'>
			<h1 className='items-center text-xl font-bold justify-center p-4'>
				Earthquake Locator
			</h1>
			<div
